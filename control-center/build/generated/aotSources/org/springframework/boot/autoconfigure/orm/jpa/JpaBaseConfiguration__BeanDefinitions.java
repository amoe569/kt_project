...
public class JpaBaseConfiguration__BeanDefinitions {
  ...
  public static class PersistenceManagedTypesConfiguration {
    ...
    private static PersistenceManagedTypes getPersistenceManagedTypesInstance() {
      List<String> managedClassNames = List.of("com.cctv.controlcenter.domain.Alert", "com.cctv.controlcenter.domain.Camera", "com.cctv.controlcenter.domain.Event", "com.cctv.controlcenter.domain.User", "com.cctv.controlcenter.domain.Video");
