 ...
 */
public class CctvControlCenterApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new CctvControlCenterApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new CctvControlCenterApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
  ...
  private void addImportAwareBeanPostProcessors(DefaultListableBeanFactory beanFactory) {
    ...
    mappings.put("org.springframework.security.config.annotation.web.configuration.WebSecurityConfiguration", "com.cctv.controlcenter.config.SecurityConfig");
    mappings.put("org.springframework.scheduling.annotation.ProxyAsyncConfiguration", "com.cctv.controlcenter.CctvControlCenterApplication");
